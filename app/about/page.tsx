...
export default function AboutPage() {
  ...
  return (
    <>
      {/* <Navigation /> */}
      <div className="pt-20">
        <div ref={sectionRef} className="py-24 bg-muted">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="scroll-reveal bg-white rounded-2xl p-8 md:p-12 soft-shadow mb-12">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                  ...
                  comprehensive support programs. We work at the intersection of education, economic empowerment, and
                  social advocacy.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Our team of dedicated professionals and volunteers brings together expertise in education, social
                  work, vocational training, and community development to create lasting impact.
                </p>
              </div>
